...
public class Controller {
    ...
    @PostMapping("/search")
    public void search(Model model, @RequestParam(value = "q", required = false) String q) {
    ...
    public String save(
        ...
        @RequestParam(value = "phone", required = true) @NotNull @NotBlank(message = "Phone is mandatory") String phone
    ) throws PhonebookAlreadyExistsException, PhonebookNotFoundException {
