...
class ControllerTest {
    ...
    void search() throws Exception {
        ...
        mockMvc
            .perform(MockMvcRequestBuilders.post("/search").param("q", q))
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(MockMvcResultMatchers.model().attribute("result", mockList));
        mockMvc
    ...
    void add() throws Exception {
        mockMvc
            ...
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(MockMvcResultMatchers.model().attribute("id", Matchers.nullValue()))
    ...
    void editExistingItem() throws Exception {
        ...
        mockMvc
            .perform(MockMvcRequestBuilders.post("/edit").param("id", mockItem.getId().toString()))
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(MockMvcResultMatchers.model().attribute("id", mockItem.getId()))
            .andExpect(MockMvcResultMatchers.model().attribute("name", mockItem.getName()))
            .andExpect(MockMvcResultMatchers.model().attribute("phone", mockItem.getPhone()));
    }
    ...
    void editNotFoundItem() throws Exception {
        ...
        mockMvc
            .perform(MockMvcRequestBuilders.post("/edit").param("id", mockItem.getId().toString()))
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(MockMvcResultMatchers.model().attribute("message", Matchers.any(String.class)));
    }
    ...
    void saveExistingItem() throws Exception {
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .post("/save")
                    .param("id", mockItem.getId().toString())
                    .param("name", mockItem.getName().toString())
                    .param("phone", mockItem.getPhone().toString())
            )
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(MockMvcResultMatchers.model().attribute("result", mockList));
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .post("/save")
                    .param("name", mockItem.getName())
                    .param("phone", mockItem.getPhone())
            )
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(MockMvcResultMatchers.model().attribute("nameMessage", Matchers.any(String.class)));
    }
    ...
    void saveInvalidItem() throws Exception {
        mockMvc
            .perform(MockMvcRequestBuilders.post("/save").param("name", "").param("phone", ""))
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(MockMvcResultMatchers.model().attribute("nameMessage", Matchers.any(String.class)))
            .andExpect(MockMvcResultMatchers.model().attribute("phoneMessage", Matchers.any(String.class)));
    }
    ...
    void delete() throws Exception {
        ...
        mockMvc
            .perform(MockMvcRequestBuilders.post("/delete").param("id", mockItem.getId().toString()))
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(MockMvcResultMatchers.model().attribute("result", Matchers.nullValue()));
    }
    ...
    void logValidData() throws Exception {
        mockMvc
            .perform(MockMvcRequestBuilders.post("/log").content("{\"name\": \"Luke Skywalker\"}"))
            .andExpect(MockMvcResultMatchers.status().isOk());
    }
